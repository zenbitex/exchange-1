...
SimpleForm.setup do |config|
  ...
  config.wrappers :default, class: 'form-group',
    ...
    ## Inputs
    #
    b.use :label, wrap_with: { tag: :div, class: 'form-label'}
    b.use :input, wrap_with: { tag: :div, class: 'form-input'}
    b.use :error, wrap_with: { tag: :span, class: 'form-error error text-danger' }
    b.use :hint,  wrap_with: { tag: :span, class: 'form-hint hint text-left' }
  end
  ...
  config.wrappers :block_checkbox_and_radio, :tag => 'div', :class => 'control-group', :error_class => 'error' do |b|
    ...
    b.wrapper :tag => 'div', :class => 'controls' do |input|
      ...
      input.use :error, :wrap_with => { :tag => :span, :class => 'form-error error text-danger' }
      input.use :hint,  :wrap_with => { :tag => :p, :class => 'form-hint hint text-left' }
    end
  end
