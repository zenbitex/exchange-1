module APIv2
  module Entities
    class Order < Base
      ...
      expose :price, documentation: "Price for each unit. e.g. If you want to sell/buy 1 btc at 3000 JPY, the price is '3000.0'"
      ...
      expose :currency, as: :market, documentation: "The market in which the order is placed, e.g. 'btcjpy'. All available markets can be found at /api/v2/markets."
