ExchangeproModel = @ExchangeproModel or require('exchangepro_model')
$      = ExchangeproModel.$
Model  = ExchangeproModel.Model
Queue  = $({})
...
class Singleton extends Base
  ...
  recordResponse: (options = {}) =>
    (data, status, xhr) =>
      ...
      Ajax.disable =>
        unless ExchangeproModel.isBlank(data) or @record.destroyed
