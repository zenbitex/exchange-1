...
ExchangeproModel = @ExchangeproModel= {}
module?.exports  = ExchangeproModel

ExchangeproModel.version    = '1.3.2.customizatiion'
ExchangeproModel.isArray    = isArray
ExchangeproModel.isBlank    = isBlank
ExchangeproModel.$          = $
ExchangeproModel.Events     = Events
ExchangeproModel.Log        = Log
ExchangeproModel.Module     = Module
ExchangeproModel.Model      = Model

# Global events

Module.extend.call(ExchangeproModel, Events)
