app.controller 'DepositsController', ['$scope', '$stateParams', '$http', '$filter', '$gon', 'ngDialog', '$sce', ($scope, $stateParams, $http, $filter, $gon, ngDialog, $sce) =>
  @deposit = {}
  ...
  $scope.deliberatelyTrustDangerousSnippet = (sniptext) ->
