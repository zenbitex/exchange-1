...
describe 'withdraw' do
  ...
  before do
    ...
    jpy_account = member.get_account(:jpy)
    #jpy_account.update_attributes balance: 0

    @label = 'common address'
    @bank = 'bc'
    @btc_addr = create :btc_fund_source, extra: @label, uid: '1btcaddress', member: member
    @jpy_addr = create :jpy_fund_source, extra: @bank, uid: '1234566890', member: member
  end
  ...
  def submit_bank_withdraw_request amount
    select 'Bank', from: 'withdraw_fund_extra'
