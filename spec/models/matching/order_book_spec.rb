...
describe Matching::OrderBook do
  ...
  context "#find" do
    subject { Matching::OrderBook.new('btcjpy', :ask) }
  ...
  context "#add" do
    ...
    it "should broadcast add event" do
      ...
      AMQPQueue.expects(:enqueue).with(:slave_book, {action: 'new', market: 'btcjpy', side: :ask}, {persistent: false})
    ...
    it "should not broadcast add event" do
      ...
      Matching::OrderBook.new('btcjpy', :ask, broadcast: false).add order
    end
  end
  ...
  context "#best_limit_price" do
    it "should return highest bid price" do
      book = Matching::OrderBook.new('btcjpy', :bid)
    ...
    it "should return lowest ask price" do
      book = Matching::OrderBook.new('btcjpy', :ask)
      o1   = Matching.mock_limit_order(type: :ask, price: '1.0'.to_d)
